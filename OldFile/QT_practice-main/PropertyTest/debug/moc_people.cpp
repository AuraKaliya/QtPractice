...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_People_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_People_t qt_meta_stringdata_People = {
    {
        QT_MOC_LITERAL(0, 6),  // "People"
        QT_MOC_LITERAL(7, 10),  // "ageChanged"
        QT_MOC_LITERAL(18, 0),  // ""
        QT_MOC_LITERAL(19, 3)   // "age"
    },
    "People",
    "ageChanged",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_People[] = {
...
Q_CONSTINIT const QMetaObject People::staticMetaObject = { {
    ...
    qt_meta_stringdata_People.offsetsAndSizes,
    qt_meta_data_People,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_People_t,
        // property 'age'
...
void People::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (People::*)(const int & );
            if (_t _q_method = &People::ageChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void People::ageChanged(const int & _t1)
{
