...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_UIWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_UIWidget_t qt_meta_stringdata_UIWidget = {
    {
        QT_MOC_LITERAL(0, 8)   // "UIWidget"
    },
    "UIWidget"
};
...
Q_CONSTINIT static const uint qt_meta_data_UIWidget[] = {
...
Q_CONSTINIT const QMetaObject UIWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_UIWidget.offsetsAndSizes,
    qt_meta_data_UIWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_UIWidget_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<UIWidget, std::true_type>
    >,
    nullptr
} };
