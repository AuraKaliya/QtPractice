...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_UIMainWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_UIMainWidget_t qt_meta_stringdata_UIMainWidget = {
    {
        QT_MOC_LITERAL(0, 12)   // "UIMainWidget"
    },
    "UIMainWidget"
};
...
Q_CONSTINIT static const uint qt_meta_data_UIMainWidget[] = {
...
Q_CONSTINIT const QMetaObject UIMainWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<UIWidget::staticMetaObject>(),
    qt_meta_stringdata_UIMainWidget.offsetsAndSizes,
    qt_meta_data_UIMainWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_UIMainWidget_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<UIMainWidget, std::true_type>
    >,
    nullptr
} };
