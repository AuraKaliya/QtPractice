...
Q_CONSTINIT static const qt_meta_stringdata_Manager_t qt_meta_stringdata_Manager = {
    {
        ...
        QT_MOC_LITERAL(8, 2),  // "me"
        QT_MOC_LITERAL(11, 0),  // ""
        QT_MOC_LITERAL(12, 8)   // "Manager*"
    },
    "Manager",
    "me",
    "",
...
Q_CONSTINIT const QMetaObject Manager::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Manager_t,
        ...
        QtPrivate::TypeAndForceComplete<Manager *, std::false_type>
    >,
    nullptr
} };
...
void Manager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->me((*reinterpret_cast< std::add_pointer_t<Manager*>>(_a[1]))); break;
        default: ;
        }
        ...
        case 0:
            ...
            default: *reinterpret_cast<QMetaType *>(_a[0]) = QMetaType(); break;
            case 0:
                *reinterpret_cast<QMetaType *>(_a[0]) = QMetaType::fromType< Manager* >(); break;
            }
            break;
        }
        ...
        {
            using _t = void (Manager::*)(Manager * );
            if (_t _q_method = &Manager::me; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
